...
import com.HFramework.enums.DriverType;
import com.HFramework.enums.Environment;
...
public class ConfigFileReader {
	...
	public String getIEPath() {
		...
		if (iePath != null) {
			...
			throw new RuntimeException("iePath not specified in the Configuration.properties file.");
		}
	}
	...
	public DriverType getBrowser() {
		...
		} else if (browserNames == null || browserNames.equals("ie")) {
